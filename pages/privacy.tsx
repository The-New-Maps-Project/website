    ...
    return <div>
        ...
        <section id="privacy-and-disclaimer">
            ...
            <p>
                ...
                site's disclaimers, please feel free to contact us by email at
                vincent.cai48@gmail.com. </p>
            ...
            <h2>Contact</h2>
            <p>Contact information is here: <Link href="/contact"><a style={{color: "green", textDecoration: "underline"}}>contact page</a></Link> </p>
        </section>
    </div>
}